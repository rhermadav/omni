...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <meta name="description" content="Omnifood is a premium  meal delivery service that brings healthy and affordable meals to as many as possible">
    ...
    <body>
        ...
        <section class="section-features js--section-features " id="features">
            <div class="row">
                <h2>Get food fast &mdash; fast food.</h2>
            ...
            <div class="row js--wp-1"> 
                ...
                </div> <div class="col span-1-of-4 box">
